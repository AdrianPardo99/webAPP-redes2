<?php
    ...
    if($var==="init_t"){
      $cmdOut=shell_exec("sudo systemctl start named");
      if(empty($cmdOut)){
          $arreglo["resultado"] = 0;
      ...
      $cmdOut=shell_exec("sudo systemctl stop named");
      if(empty($cmdOut)){
          $arreglo["resultado"] = 0;
          $arreglo["mensaje"] = "Petici&oacuten procesada correctamente: $var";
      }else{
      ...
      $cmdOut=shell_exec("sudo systemctl restart named");
      if(empty($cmdOut)){
          $arreglo["resultado"] = 0;
          $arreglo["mensaje"] = "Petici&oacuten procesada correctamente: $var";
      }else{
      ...
      $cmdOut=shell_exec("sudo systemctl status named | grep Active");
      $arreglo["resultado"] = 0;
